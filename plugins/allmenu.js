...
`.trimStart(),
  ...
  footer: '╰─── –',
  after: `ᴇʟᴀɪɴᴀ ᴀɪ ʙʏ「 ᴇʟᴀɪɴᴀ 𝙱𝙾𝚃 汉  」 ${global.version}`,
}
  try {
 ...
 type: 'audioMessage',  
 ptt: true, contextInfo: { forwardingScore: 999, isForwarded: false, externalAdReply: {title: 'ᴇʟᴀɪɴᴀ ᴍᴜʟᴛɪᴅᴇᴠɪᴄᴇ', body: wm, sourceUrl: 'https://whatsapp.com/channel/0029VaEvOpP35fLtqPxd4F2L', thumbnail: await (await fetch(bjir)).buffer(),}}  
  }) 
    } catch (e) {
